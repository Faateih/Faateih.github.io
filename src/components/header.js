  ...
  return (
    <div style={{ position: "fixed", zIndex: 2000, width: "100vw" }}>
      <div className="header" style={props.style}>
        {open === true && (
          <div className="navbr" data-aos="fade-right" data-aos-duration="400">
            <div className="navbr__color">
              <ul className="navbr__ul">
                <Link to="aboutus" target="_top" className="navbr__link">
                  About Us
                </Link>
                <Link to="services" target="_top" className="navbr__link">
                  Services
                </Link>
                <Link to="technologies" target="_top" className="navbr__link">
                  Technology
                </Link>
                <Link to="product" target="_top" className="navbr__link">
                  Product
                </Link>
                {/* <li className='navbr__link'>Blog</li> */}
              </ul>
              <Link to="contactus" className="navbr__button">
                {" "}
                Contact Us{" "}
              </Link>
