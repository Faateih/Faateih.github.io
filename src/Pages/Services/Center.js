        ...
        <div className='center'>
           <div className='center__left'>
               ...
               <div className='center__right'>
                   ...
                   <Cards icons={design} title = 'Product Design' title2 = 'We will identify the scope of the application, the phase of its creation, industry or suitability. We will focus most on the capabilities.' button='Click Here' />
