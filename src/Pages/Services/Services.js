 ...
 {/* <div className='center'>
           <div className='center__left'>
               ...
               <div className='center__right'>
                   ...
                   <Cards icons={support} title = 'IT outsourcing service' title2 = 'We will optimize development costs and assess your capabilities thanks to our practical knowledge and experience in the IT industry.' button='Click Here' />
                   ...
                   <Cards icons={design} title = 'Product Design' title2 = 'We will identify the scope of the application, the phase of its creation, industry or suitability. We will focus most on the capabilities and performance of the application.' button='Click Here' />
